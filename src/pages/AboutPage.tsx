...
import flowerWithPeople from "../picturesFolder/aboutPage/flower_with_people.png";
  ...
  return (
    <section className="aboutSection">
      <div className="about-section howItWorks">
        ...
        <p className="about-section__text last-text">
        ...
        <div className="flower-with-people">
          <img src={flowerWithPeople} alt="people" />
          <div className="flower-text">
            what if the way we respond to the planetary and human crisis is
            (part of) <br /> the crisis?
          </div>
        </div>
